...
천사와 악마는 흔한 소재이지만 표현할 수 있는 부분이 한계가 있는 탑 뷰 형식 게임에서 플레이어에게 확실한 이미지를 전달할 수 있음
...
1) 핵심 규칙  
1.게임 시작후 교단 주 교단과 부 교단을 선택한다.
2.주교단은 무기를 부교단은 기술을 제공한다.
3.무기는 공격(좌클릭)을 변화 시키며 기술은 스킬(휠클릭)을 변화시킨다
2.게임 상단에 전투 시간이 표시되고 플레이어는 이 시간동안 공격과 스킬을 사용해 몰려오는 적들을 처치한다.   
