...
|공격 대기|공격|플레이어가 마우스 좌클릭을 눌렀을 때|  
|공격|공격 대기|공격의 지속시간이 끝났을 때|  
...
|스킬 쿨타임|SkillDelay|공격을 너무 빨리 연사할 수 없도록 비활성화 하는 시간||  
...
2) 시작 화면에는 게임 시작, 게임 종료라는 버튼 2개가 있다.  
...
7) 시작화면에서 게임 시작 클릭 시 스테이지 화면으로 이동한다.  
<br>
...
## 요구사항(6주)
- 시작 화면, 준비 화면, 게임 화면 총 3개의 화면이 있다.  
- 시작 화면에는 게임 시작, 게임 종료라는 버튼 2개가 있다.  
